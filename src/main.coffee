...
@$main = ( S ) =>
  ...
  return D.TEE.from_pipeline [
    ...
    @$dump_db.$format                             S
    #.......................................................................................................
    @$dictionary_readings_and_gloss               S
    ]
...
@$fontlist = ( S ) =>
  ...
  #.........................................................................................................
  template = """
    {\\($texname) AaBbCcDdEeFfghijklmnopqrstuvwxyz {\\cjk\\($texname){}永東國酬愛鬱靈鷹袋南去經三國，東來過五湖东国爱郁灵鹰经来过}}
    """
  #.........................................................................................................
  template = """
    {\\($texname) {\\cjk\\($texname){}𠕋𠕋𧱆}}
    """
  #.........................................................................................................
  template = """
...
@$dictionary_readings_and_gloss = ( S ) =>
  ...
  return $ ( event, send ) =>
    ...
    if select event, '(', [ 'py', 'ka', 'hi', 'hg', 'gloss', ]
      send stamp event
      send [ 'tex', "{\\#{name}{}", ]
    #.......................................................................................................
    else if select event, ')', [ 'py', 'ka', 'hi', 'hg', 'gloss', ]
      send stamp event
      send [ 'tex', "}", ]
    #.......................................................................................................
